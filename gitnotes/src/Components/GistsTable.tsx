                  ...
                  <TableRow hover role="checkbox" tabIndex={-1} key={row.id}>
                    <TableCell>
                      <Box display="flex" alignItems="center">
                        <Avatar src={row.ownerImageUrl} alt="User" sx={{ width: 40, height: 40, marginRight: '10px' }} />
                        {row.ownerName}
                      </Box>
                    </TableCell>
                    ...
                    <TableCell align="right" sx={{display: 'flex'}}>
                      <IconButton onClick={() => handleStarClick(row.id)} aria-label="star">
                        <StarIcon />
                      </IconButton>
                      <IconButton onClick={() => handleForkClick(row.id)} aria-label="fork">
                        <ForkRightIcon />
                      </IconButton>
                    </TableCell>
                  </TableRow>
